...
const Page = () => {
	return (
		<Content>
			...
			<h1>Impressum</h1>
			<p>
				Angaben gemäß § 5 TMG: <br />Fatih Sahanoglu<br />Friseur/Stylist/Fotograf<br />Schaarschmidtstr.
				32 <br />80995 München
			</p>
			<h3>Kontakt:</h3>
			<p>
				Telefon: +49 176 20 977 087 <br />Email:
				fatih@fatih-sahanoglu.com
			</p>
			<p>
				Umsatzsteuer-Identifikationsnummer gemäß §27 a
				Umsatzsteuergesetz: <br />146/181/81295
			</p>
			<h3>Haftungsausschluss:</h3>
			<p>
				Haftung für Inhalte <br />Die Inhalte unserer Seiten wurden mit
			...
			<p>
				...
				ausdrückliche Zustimmung nicht an Dritte weitergegeben. <br />Wir
